...
export function ArrowUpRightIcon() {
  return (
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="text-stone-400">
...
export function VerifiedSeal() {
  return (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="#2d5130" aria-hidden className="shrink-0">
...
export function LeafIcon() {
  return (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M11 20A7 7 0 019.8 6.1C15.5 5 17 4.5 19.2 3 21 8 21 13 19 17a7 7 0 01-8 3z" /><path d="M2 21c0-3 1.85-5.36 5.08-6" />
    </svg>
  );
}
...
export function BadgeCheckIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M3.85 8.62a4 4 0 014.78-4.77 4 4 0 016.74 0 4 4 0 014.78 4.78 4 4 0 010 6.74 4 4 0 01-6.74 0 4 4 0 01-4.78-4.77 4 4 0 010-6.74z" /><path d="M9 12l2 2 4-4" />
    </svg>
  );
}
