              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-yellow-50 text-yellow-400 font-semibold"
                ...
                >
                  {active && (
                    <span
                      aria-hidden
                      className="absolute -left-3 top-1/2 h-5 w-1 -translate-y-1/2 rounded-r-full bg-yellow-400"
                    />
                  )}
                  <span
                    className={cn(
                  ...
                  {item.href === "/admin/verifications" && pendingVerificationsCount > 0 && (
                    <span
                      ...
                      className="inline-flex min-w-[18px] items-center justify-center rounded-full bg-yellow-500 px-1.5 text-[10px] font-semibold leading-[18px] text-stone-900"
                    >
      ...
      <div className="border-t border-stone-200 px-3 py-3">
        ...
        <div className="mt-2 flex items-center justify-between rounded-lg px-3 py-2">
          <div className="min-w-0">
            ...
            <div className="text-[10px] uppercase tracking-wider text-yellow-500">
              Admin
            </div>
          </div>
