            ...
            <section className="rounded-2xl bg-white p-6 shadow-[var(--shadow-card)]">
              ...
              {reporter ? (
                <div className="mt-3 flex items-center gap-4">
                  <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-indigo-100 text-sm font-semibold text-indigo-800">
...
function CategoryChip({ category }: { category: ReportCategory }) {
  const styles: Record<ReportCategory, string> = {
    ...
    fraud: "bg-indigo-100 text-indigo-800 ring-indigo-200",
...
function Banner({
  ...
  const cls = {
    ...
    warning: "bg-indigo-50 text-indigo-800 ring-indigo-100",
  }[variant];
  return (
