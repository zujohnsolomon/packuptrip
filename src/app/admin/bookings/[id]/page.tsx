            ...
            <section className="rounded-2xl bg-white p-6 shadow-[var(--shadow-card)]">
              ...
              {user ? (
                <div className="mt-3 flex items-center gap-4">
                  <div className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-yellow-100 text-base font-semibold text-yellow-400">
...
function Banner({
  ...
  const cls =
    variant === "warning"
      ? "bg-yellow-50 text-yellow-400 ring-yellow-100"
