...
function Avatar({
  ...
  return (
    <div
      className={`shrink-0 overflow-hidden rounded-full bg-indigo-100`}
    ...
    >
      {member.avatar_url ? (
        ...
        <div
          className="flex h-full w-full items-center justify-center font-semibold text-indigo-700"
    ...
    <div className="flex h-full flex-col">
                ...
                <div className={`flex max-w-[72%] flex-col ${isMe ? "items-end" : "items-start"}`}>
                  ...
                  {isFirstInGroup && sender && (
                    <div className="mb-1 flex items-center gap-1.5 px-1">
                      {isMe ? (
                        <span className="text-[11px] font-semibold text-indigo-600">You</span>
                      ) : (
                        <a
                  ...
                  {msg.deleted_at ? (
                    ...
                    <div
                      ...
                      className={`select-none rounded-2xl px-3.5 py-2 text-sm leading-relaxed ${
                        ...
                        isMe
                          ? `bg-indigo-500 text-white ${isOptimistic ? "opacity-70" : ""} ${
      ...
      <div className="border-t border-stone-100 bg-white px-4 py-3">
        <div className="flex items-end gap-2">
          ...
          <div className="flex flex-1 items-end gap-2 rounded-2xl border border-stone-200 bg-stone-50 px-3 py-2 focus-within:border-indigo-300 focus-within:bg-white focus-within:ring-2 focus-within:ring-indigo-100 transition-all">
            <textarea
              ref={inputRef}
              value={input}
            ...
            <button
              ...
              className="mb-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-indigo-500 text-white transition hover:bg-indigo-600 disabled:opacity-40"
              aria-label="Send"
            >
