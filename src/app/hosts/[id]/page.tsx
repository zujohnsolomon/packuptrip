                  ...
                  <div className="mb-4 flex flex-col items-center gap-3 text-center">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center justify-center gap-1.5">
                        ...
                        {profile.host_tier === "superhost" && (
                          <span className="inline-flex items-center gap-0.5 rounded-full bg-yellow-100 px-2 py-0.5 text-[11px] font-semibold text-yellow-800">
                            ⭐ Superhost
                          </span>
                        )}
                      </div>
                ...
                <div className="mt-4 space-y-2 border-t border-stone-100 pt-4">
                  {profile.host_tier === "superhost" && (
                    <div className="flex items-center gap-2 text-sm text-stone-600">
                      ...
                      <span><span className="font-semibold text-yellow-700">Superhost</span> — top-rated trusted host</span>
                    </div>
                  )}
                  {profile.id_verified && (
                    <div className="flex items-center gap-2 text-sm text-stone-600">
                ...
                <div className="rounded-2xl border border-dashed border-stone-200 p-12 text-center text-stone-400">
                  ...
                  {isOwnProfile && (
                    <div className="mt-4">
                      <Link
                        href="/host/new"
                        className="inline-flex items-center rounded-full bg-yellow-500 px-5 py-2 text-sm font-semibold text-white hover:bg-yellow-600"
                      >
                        Post a trip →
                      </Link>
                    </div>
