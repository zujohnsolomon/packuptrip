...
export function PasswordForm() {
  ...
  const strengthColor = ["bg-red-400", "bg-orange-400", "bg-yellow-400", "bg-green-600"][strength];
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-stone-200 bg-stone-50 px-4 py-2.5 pr-11 text-sm text-ink placeholder:text-stone-400 focus:border-yellow-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-yellow-100"
            />
            <button
              type="button"
