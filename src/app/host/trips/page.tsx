    ...
    <>
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-center">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {trip.admin_notes && (
            <span className="inline-flex items-center rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-semibold text-amber-800 ring-1 ring-inset ring-amber-200">
              Admin notes
            </span>
          )}
  ...
  if (sp.submitted) {
    return (
      <Banner variant="success">
        ...
        <em className="not-italic font-semibold text-amber-800">pending</em> to{" "}
