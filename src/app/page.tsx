  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 rounded-2xl bg-white p-2 shadow-[var(--shadow-search)] sm:flex-row sm:items-stretch">
        ...
        <button
          type="submit"
          className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 sm:h-auto sm:w-auto sm:shrink-0 sm:px-7"
        >
          <SearchIcon />
          Search
        </button>
      ...
      <div className="p-6 sm:p-8">
        ...
        <span
          className={`mt-5 inline-flex items-center gap-1.5 text-sm font-semibold ${
            isOriginals ? "text-indigo-700" : "text-green-800"
          }`}
        >
          {cta.label}
          <ArrowRightIcon />
...
function TravelCategories() {
  const cats = [
    ...
    { label: "Heritage", emoji: "🏛️", href: "/trips?q=heritage", bg: "from-indigo-500 to-orange-600" },
